	...
	if (isset($_POST['products'])){
		...
		if(mysqli_num_rows($query)>0){
			while($row = mysqli_fetch_array($query)){
				echo "<tr class='js-add' data-quantity=".$row['quantity']." data-barcode=".$row['product_no']." data-product=".$row['product_name']." data-price=".$row['sell_price']." data-unt=".$row['unit']."><td>".$row['product_no']."</td><td>".$row['product_name']."</td>";
