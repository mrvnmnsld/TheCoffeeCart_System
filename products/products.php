...
<body>
	<div class="table-responsive contain h-100">
			...
			<table class="table table-striped table-bordered" id="product_table" style="margin-top: -22px;">
				<thead>
					<tr>
						...
						<th scope="col" class="column-text">Min. Stocks</th>
				...
				<tbody class="table-hover">
					...
					<tr class="table-active">
						...
						<td class="<?php echo $row['quantity']<= 20 ? 'bg-danger' : 
                                    ($row['quantity']<= 50 ? 'bg-warning' : '')
                                    ?>"bgcolor="#ccfccd"><?php echo $row['quantity'];?></td>
