...
<body>
	...
	<button id="sidebar_button" onclick="window.location.href='../delivery/add_delivery.php'"><i class="fas fa-truck"></i> Purchase Order</button>
	...
	<div class="fixed-bottom">
		...
		<div class="main">
			<div class="side">
			<h1 class="ml-4 pt-2"><i class="fas fa-box-open"></i> Product Inventory</h1>
				<hr>
			</div>
					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div><input type="text" name="remarks" value="<?php echo $row1['remarks'];?>" class="form-control-sm form-control"></div></td>
							</tr>
							<tr>
