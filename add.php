	...
	<div class="modal-dialog modal-fluid" role="document">
		<div class="modal-content" style="width:70%; margin-left: 20%;">
	  		<div class="modal-header bg-secondary">
				<h4 class="modal-title text-light" id="exampleModalCenterTitle" ><strong>New Order Name</strong></h4>
			...
			<div class="container-fluid">
				<form method="post" id="modal-form" action="add_customer.php" enctype="multipart/form-data" class="needs-validation">
		  			...
		  			<div align="center">
		  				...
		  				<input type="hidden" name="user" class="form-control-sm" value="">
		  				...
		  				<input class="form-control form-control-sm" type="text" name="fname" placeholder="Enter Order name" ></div>
